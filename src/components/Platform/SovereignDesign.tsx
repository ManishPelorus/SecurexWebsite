...
const SovereignDesign = () => {
  const items = [
    ...
    {
      icon: <Globe className="h-6 w-6 text-slate-300" />,
    ...
    {
      icon: <Server className="h-6 w-6 text-slate-300" />,
  ...
  return (
    <div className="mt-16 max-w-full px-4 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-[40px] border border-slate-600/20 bg-slate-950/95 p-6 shadow-[0_45px_140px_rgba(0,0,0,0.45)]">
            ...
            <div className="rounded-[32px] border border-white/[0.08] bg-slate-900/95 p-6 shadow-[0_25px_80px_rgba(0,0,0,0.25)]">
              <div className="grid gap-5">
                {items.map((item, index) => (
                  ...
                  >
                    <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-700/20 text-slate-300 ring-1 ring-slate-600/30">
                      {item.icon}
                    </div>
